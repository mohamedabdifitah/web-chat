...
import MiniEmojiPicker from "../../../../components/emoji-picker/min-emoji-picker";
const LeftMessage = () =>{
  const SvgRef = useRef()
  function SetHover(){
    if(SvgRef.current){
